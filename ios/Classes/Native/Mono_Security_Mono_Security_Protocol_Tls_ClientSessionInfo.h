...
struct  ClientSessionInfo_t589  : public Object_t
{
	...
	ByteU5BU5D_t356* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t356* ___masterSecret_5;
};
struct ClientSessionInfo_t589_StaticFields{
