...
public class main : MonoBehaviour {
	...
	void Start () {
		...
		savemoney = PlayerPrefs.GetString(Data7, "0,50,0,1500,0,10000,0,50000,0,200000,0,500000,0,1000000,0,3000000,0,7000000,0,15000000,0,30000000,0,50000000,0,80000000,0,1,3,5,10,20,50,100,999");
	...
	public void OnGUI() {
		...
		if (r == 1) {
			if (GUI.Button (new Rect (160 * sw, 500 * sh, 200 * sw, 100 * sh), "リセットする")) {
				...
				savemoney="0,50,0,1500,0,10000,0,50000,0,200000,0,500000,0,1000000,0,3000000,0,7000000,0,15000000,0,30000000,0,50000000,0,80000000,0,1,3,5,10,20,50,100,999";
				...
				PlayerPrefs.SetString (Data7,"0,50,0,1500,0,10000,0,50000,0,200000,0,500000,0,1000000,0,3000000,0,7000000,0,15000000,0,30000000,0,50000000,0,80000000,0,1,3,5,10,20,50,100,999");
